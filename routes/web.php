...
Route::group(['middleware' => 'auth'], function() {
	...
	Route::resource('admin/exam','Admin\ExamController', array('as'=>'admin'));
	/*tag*/
	...
	Route::post('admin/post/categorybyid/{_cattype}/{_idcat}',['uses' =>'Admin\PostsController@categorychildbyid', 'as'=>'admin']);
	Route::get('admin/post/categorybyid/{_cattype}/{_idcat}',['uses' =>'Admin\PostsController@categorychildbyid', 'as'=>'admin']);
