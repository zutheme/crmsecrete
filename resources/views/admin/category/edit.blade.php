...
<div class="row">
	<div class="col-sm-6">
		...
		@endif
		<form class="frm_create_category" method="post" action="{{ action('Admin\CategoryController@update',$_idcategory) }}" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="form-group row">
                ...
                <div class="col-lg-8">
					<input type="text" name="icon" class="form-control" value="{{$categorybyid->icon}}">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-lg-4 col-form-label" for="sel_idcattype">Image <span class="text-danger">*</span></label>
                <div class="col-lg-8">
					<img width="200px" src="{{ asset($categorybyid->url_image) }}"/>
				</div>
...
@section('other_scripts')
    ...
    <script src="{{ asset('dashboard/production/js/media-galerry.js?v=0.8.0') }}"></script>
