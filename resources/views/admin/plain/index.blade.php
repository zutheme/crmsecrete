...
@section('other_styles')
    ...
    <!-- Custom Theme Style -->
   <link href="{{ asset('gentelella/production/css/plain.css?v=0.0.5') }}" rel="stylesheet">
@stop
@section('content')
<?php 
...
?>
    @include('admin.plain.index-plain') 
@stop
...
@section('other_scripts')
	...
	<script src="{{ asset('gentelella/production/js/caculate.js?v=0.0.1.7') }}"></script>
