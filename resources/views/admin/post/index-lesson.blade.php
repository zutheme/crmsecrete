          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%"> 
              ...
              <tbody>
                      ...
                      <tr>
						...
						<td><input class="idexam" type="text" placeholder="Mã đề">&nbsp;<a idcrosstype ="7" iduser ="{{ $iduser }}" href="javascript:void(0);" onclick="addquiztoexam(this, {{ $row['idproduct'] }}); " class="btn btn-default btn-primary"><i class="fa fa-arrow-right"></i></a></td>
                      </tr>
                      @endforeach  
                    </tbody>
