             ...
             <form method="post" action="{{  url('/admin/latestpostbytype/'.$posttype) }}">
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="btn-control-action">
				  <a href="{{ action('Admin\PostsController@create',['idposttype' => $row['id_post_type'], 'idparent' => $row['idproduct'],'idcrosstype' => 0, 'iddirect' => 2]) }}" class="info-number"><i class="fa fa-truck"></i></a>
                  </td> 
                </tr>
                @endforeach  
              </tbody>
