<div class="col-md-9 col-xs-12">
	<div class="col-md-6 col-xs-12">
		<h2>Mã đề:{{ $product[0]['idproduct'] }}</h2>
	</div>
	<div class="col-md-6 col-xs-12">
	...
	<div class="col-md-9 col-xs-12">
		...
		<div class="form-group row">
			<div class="col-md-12 text-center">
			  <a class="btn btn-default btn-primary" href="{{ action('Admin\PostsController@create',['idposttype' => 29, 'idparent' => $idproduct,'idcrosstype' => 7]) }}" class="btn btn-default btn-create-new">Tạo mới câu hỏi</a>
			</div>
		 </div>
		<div class="form-group row">
			<div class="col-md-12">
			@include('admin.post.list-quiz')
			</div>
		</div>
		<div class="form-group row">
			<div class="col-md-12">
			@include('admin.post.exam-dragula')
			</div>
		</div>
	</div>
