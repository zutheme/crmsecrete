...
?>
  ...
  @elseif($posttype=='lesson')
     @include('admin.post.index-lesson')
...
@section('other_scripts')
    ...
    <script src="{{ asset('gentelella/build/js/custom-init.js?v=0.1.9.6') }}"></script> 
    <script src="{{ asset('gentelella/vendors/jquery.tagsinput/src/jquery.tagsinput.js') }}"></script>
    <script src="{{ asset('dashboard/production/js/filter_select_category.js?v=0.3.1') }}"></script> 
