                      ...
                      <div class="col-md-12 col-sm-12 ">
                        <div class="dashboard_graph">
                          <div class="row x_title">
                            <div class="col-md-6">
                              <h3>Quản lý bài học<small></small></h3>
                            </div>
                            <div class="col-md-6">
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%"> 
              ...
              <tbody>
                      ...
                      <tr>
						...
						<td><input class="idexam" type="text" placeholder="Mã đề">&nbsp;<a idcrosstype ="7" iduser ="<?php echo e($iduser); ?>" href="javascript:void(0);" onclick="addquiztoexam(this, <?php echo e($row['idproduct']); ?>); " class="btn btn-default btn-primary"><i class="fa fa-arrow-right"></i></a></td>
                      </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                    </tbody>
...
</div><?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/admin/post/index-lesson.blade.php ENDPATH**/ ?>