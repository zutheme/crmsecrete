...
<li id="liprofile" class="dropdown header-profile" style="display:none">
	<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
		<img src="<?php echo e($url_avatar); ?>" width="20" alt=""/>
		<div class="header-info ms-3">
			<span class="font-w600 ">Hi,<b><?php echo e($firstname); ?></b></span>
			<small class="text-end font-w400"><?php echo e($email); ?></small>
		</div>
	</a>
...
?><?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/teamilk/learning/sidebar.blade.php ENDPATH**/ ?>