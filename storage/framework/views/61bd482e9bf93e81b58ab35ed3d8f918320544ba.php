	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<?php endif; ?>
				<div align="right">
					<a class="btn btn-default btn-primary" href="<?php echo e(route('admin.attribute.create')); ?>">Thêm mới</a>
				</div>
				<div class="table-responsive m-t-40">
					<table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
						<?php if(isset($rs_attributes)): ?>
							<?php $__currentLoopData = $rs_attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
									<td><?php echo e($row['idattribute']); ?></td>					
									<td><?php echo e($row['nameattribute']); ?></td>
									<td><?php echo e($row['nametype']); ?></td>
									<td class="btn-control"><a class="btn btn-primary btn-edit" href="<?php echo e(action('Admin\AttributeController@edit',$row['idattribute'])); ?>"><i class="fa fa-edit"></i></a></td>
									<td class="btn-control">
										 <form method="post" class="delete_form" action="<?php echo e(action('Admin\AttributeController@destroy', $row['idattribute'])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/admin/attribute/index.blade.php ENDPATH**/ ?>