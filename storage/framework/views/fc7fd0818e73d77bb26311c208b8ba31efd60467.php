   ...
   <div class="row">
	...
	<div class="card">
	    <div class="card-body">
			...
			<?php endif; ?>
			<div align="right">
				<a class="btn btn-default btn-primary" href="<?php echo e(route('admin.posttype.create')); ?>">Thêm mới</a>
			</div>
	                ...
	                <tbody>
	                	<?php $__currentLoopData = $posttypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								...
								<td><?php echo e($row['idparent']); ?></td>						
								<td class="btn-control"><a class="btn btn-primary btn-edit" href="<?php echo e(action('Admin\PostTypeController@edit',$row['idposttype'])); ?>"><i class="fa fa-edit"></i></a></td>
								<td class="btn-control">
								     <form method="post" class="delete_form" action="<?php echo e(action('Admin\PostTypeController@destroy', $row['idposttype'])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/admin/posttype/index.blade.php ENDPATH**/ ?>