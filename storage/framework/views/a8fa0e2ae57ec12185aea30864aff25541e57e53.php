...
<head>
  ...
  <script>
	...
	<?php if($template == 'home'||$template == 'chat'): ?>
		 <!-- Main CSS File -->
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/riode/css/demo-food.min.css?v=0.0.1')); ?>">
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/style-chat.css?v=0.0.4')); ?>">
	<?php endif; ?>
...
<div class="page-wrapper">
        <h1 class="d-none"><?php echo e($title); ?></h1>
        <header class="header">
	...
	<?php echo $__env->make('teamilk.riode.popup-process', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<script src="<?php echo e(asset('public/riode/vendor/magnific-popup/jquery.magnific-popup.js')); ?>"></script>
    <script src="<?php echo e(asset('public/riode/vendor/owl-carousel/owl.carousel.min.js')); ?>"></script>
    <!-- Main JS File -->
    <script src="<?php echo e(asset('public/riode/js/main.js?v=0.0.3')); ?>"></script>
	<script src="<?php echo e(asset('public/riode/js/custom-product.js?v=1.7.1.1')); ?>"></script>
	<script src="<?php echo e(asset('public/riode/js/format-price.js?v=0.0.4')); ?>"></script>
	<?php if($template == 'product'): ?>
		 <script src="<?php echo e(asset('public/riode/vendor/sticky/sticky.min.js')); ?>"></script>
		 <script src="<?php echo e(asset('public/riode/vendor/nouislider/nouislider.min.js')); ?>"></script>
	<?php elseif($template == 'chat'): ?>
		<!--<script src="https://cdn.socket.io/4.0.1/socket.io.min.js" integrity="sha384-LzhRnpGmQP+lOvWruF/lgkcqD+WDVt9fU3H4BWmwP5u5LTmkUGafMcpZKNObVMLU" crossorigin="anonymous"></script>-->
		 <script src="https://cdn.socket.io/3.1.3/socket.io.min.js" integrity="sha384-cPwlPLvBTa3sKAgddT6krw0cJat7egBga3DJepJyrLl4Q9/5WLra3rrnMcyTyOnh" crossorigin="anonymous"></script>
		<script src="<?php echo e(asset('public/js/client_node.js?v=0.4.7')); ?>"></script>
	<?php endif; ?>
...
<?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/teamilk/master.blade.php ENDPATH**/ ?>