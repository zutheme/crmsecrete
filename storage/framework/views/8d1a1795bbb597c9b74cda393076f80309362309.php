...
?>
  ...
  <?php elseif($posttype=='lesson'): ?>
     <?php echo $__env->make('admin.post.index-lesson', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('other_scripts'); ?>
    ...
    <script src="<?php echo e(asset('gentelella/build/js/custom-init.js?v=0.1.9.6')); ?>"></script> 
    <script src="<?php echo e(asset('gentelella/vendors/jquery.tagsinput/src/jquery.tagsinput.js')); ?>"></script>
    <script src="<?php echo e(asset('dashboard/production/js/filter_select_category.js?v=0.3.1')); ?>"></script> 
