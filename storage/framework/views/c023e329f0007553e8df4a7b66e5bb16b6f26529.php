<form class="frm_create_post" method="post" action="<?php echo e(action('Admin\PostsController@store',['idparent' => $idparent,'idcrosstype' => $idcrosstype])); ?>" onsubmit="return readytextarea()" enctype="multipart/form-data">
	<?php echo e(csrf_field()); ?>

	<div class="col-md-9 col-xs-12">
	<div class="form-group">		
		<?php if(isset($idparent)): ?>
			<a class="btn btn-default" href="<?php echo e(action('Admin\PostsController@edit',$idparent)); ?>">&nbsp;<i class="fa fa-angle-double-left"></i>&nbsp;Về bài học chính</a>
		<?php endif; ?>
	</div>
	<div class="form-group">
...
</form><?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/admin/post/create-lesson.blade.php ENDPATH**/ ?>