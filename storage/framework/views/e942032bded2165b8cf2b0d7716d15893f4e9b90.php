...
<form class="frm_edit_post" method="post" action="<?php echo e(action('Admin\PostsController@update',[$idproduct,'idparent'=>$idparent])); ?>" enctype="multipart/form-data">
	 ...
	 <div class="form-group row">
	  ...
	  <div class="form-group row">
	   ...
	   <div class="form-group row">
		...
		<div class="col-md-9 col-sm-9 col-xs-12">
			<?php if(isset($rs_diff) and isset($rs_diff[0]['idinteractive'])): ?>
				<input type="hidden" name = "idinteractive" value="<?php echo e($rs_diff[0]['idinteractive']); ?>" />
			<?php endif; ?>
			<?php if(isset($rs_diff) and isset($rs_diff[0]['difflevel'])): ?>
				<input type="number" name="difflevel" class="form-control" value="<?php echo e($rs_diff[0]['difflevel']); ?>" min="0" max="10" />
			<?php else: ?>
...
<?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/admin/post/edit-lesson.blade.php ENDPATH**/ ?>