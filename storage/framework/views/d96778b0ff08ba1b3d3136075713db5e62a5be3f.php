...
<?php $__env->startSection('other_styles'); ?>
   <!-- Custom Theme Style -->
    <link href="<?php echo e(asset('dashboard/production/css/custom.css?v=0.9.7')); ?>" rel="stylesheet">
    <!-- Custom Theme Style -->
...
<div class="row">
	...
	<?php elseif($idposttype == 29): ?>
		<?php echo $__env->make('admin.post.create-lesson', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmenergy/domains/crm.secretenergy.net/public_html/resources/views/admin/post/create.blade.php ENDPATH**/ ?>