...
var _e_modal_media = document.getElementsByClassName('modal-media')[0];
var _e_media_form = document.getElementsByClassName('frm-media')[0];
var _e_bnt_insert_media = document.getElementsByClassName('btn-insert-picture')[0];
...
function show_media_popup(){
  if(!_e_modal_media) return false;
